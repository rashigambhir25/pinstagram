...
import com.example.pinstagram.MyProfile.PostImage;
...
public class StoryImage extends AppCompatActivity {
...
//        actionBar.setBackgroundDrawable(colorDrawable);
        ...
        // initialise views
        btnSelect = findViewById(R.id.btnChoose_story);
        btnUpload = findViewById(R.id.btnUpload_story);
        imageView = findViewById(R.id.imgView_story);
        ...
        if (filePath != null) {
            ...
            ref.putFile(filePath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot)
                {
                    ...
                    Toast.makeText(StoryImage.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            res.enqueue(new Callback<Void>() {
                                ...
                                public void onResponse(Call<Void> call, Response<Void> response) {
                                    Toast.makeText(StoryImage.this,"Posted",Toast.LENGTH_SHORT).show();
                                }
                                @Override
                ...
                {// Error, Image not uploaded
                    progressDialog.dismiss();
                    Toast.makeText(StoryImage.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            })
